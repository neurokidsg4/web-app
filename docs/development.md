...
|RF-003|A aplicação deve conter sugestões de atividades escolares para crianças neurodiversas.|ALTA| Wesley Bruno | **** |
...
|RF-010|A aplicação deve permitir que os usuários efetuem o login em contas previamente criadas. |ALTA| Wesley Bruno | ******* |
...
|RF-012|A aplicação deve fornecer recursos de documentação acessíveis para ajudar os usuários a aproveitar ao máximo a aplicação.|MÉDIA| Todos os integrantes | index.html
