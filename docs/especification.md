...
|RF-005|Deve conter sessões específicas para cada demanda de persona. Ex: pais, educadores, crianças, etc. Assim a informação é melhor concentrada de acordo com o tipo de necessidade do usuário|
...
|RNF-007|Os dados devem ser armazenados de forma segura em conformidade com a LGPD (Lei Geral de Proteção dos Dados).
<!--
...
|03| A aplicação não deve permitir que o acesso a informações pessoais dos usuários.|
|04|O usuário deve ser informado caso tente cadastrar um email fora do padrão, através de uma mensagem impressa em algum lugar da tela|
