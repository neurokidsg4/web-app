...
![Ana](https://github.com/ICEI-PUC-Minas-PMV-SI/pmv-si-2023-2-pe1-t2-neurodiversidade/assets/89950149/35da4c9c-9066-40ba-9564-81d710060857)
...
![Lucas](https://github.com/ICEI-PUC-Minas-PMV-SI/pmv-si-2023-2-pe1-t2-neurodiversidade/assets/99815953/2a497241-8344-426a-a2b1-7781e3b5251e)
...
|ID    | Descrição do Requisito  | Prioridade | Responsável |
|------|-----------------------------------------|----| ----|
|RF-001|A aplicação deve conter uma página principal de apresentação dos conteúdos.| ALTA |  |
|RF-002|A aplicação deve permitir que o usuário crie uma conta de acesso.| ALTA | |
|RF-003|A aplicação deve permitir que o usuário faça login.|ALTA| |
|RF-004|A aplicação deve permitir a visualização do perfil.|ALTA| |
|RF-005|A aplicação deve permitir editar as informações do perfil.|ALTA|
|RF-006|A aplicação deve permiti que o usuário exclua sua conta.|Alta|
|RF-007|A aplicação deve conter uma sessão específica para crianças neurodiversas.|ALTA|
...
|RNF-007|A aplicação deve conter conteúdos de atividades propostas para crianças. |ALTA|
|RNF-008|A aplicação deve utilizar o Google Material Design como layout.|MÉDIA|
|RNF-009|A aplicação deve informar o usuário caso tente inserir algum dado inválido no formulário de cadastro e de editar o perfil.|MÉDIA|
